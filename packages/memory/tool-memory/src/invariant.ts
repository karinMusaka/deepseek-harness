...
/**
 * No runtime invariant: this model-facing adapter owns no independent state or
 * event protocol; accepted mutations are checked by the memory domain and
 * authority behavior is package-tested.
 */
