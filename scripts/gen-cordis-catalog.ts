...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  skills: 'skills.md',
  staticCordisPackages: 'extensions.md',
  spillStore: 'spill.md',
  storage: 'storage.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  StaticCordisPackageRow: 'static-package payload contract is owned by packages/extensions/cordis-static-packages/src/types.ts',
  StaticCordisClientSource: 'static-package payload contract is owned by packages/extensions/cordis-static-packages/src/types.ts',
  StaticCordisInvokeResult: 'static-package payload contract is owned by packages/extensions/cordis-static-packages/src/types.ts',
