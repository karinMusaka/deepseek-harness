...
- `@deepseek-ai/dsh-tool-memory` — requires `memory` · `tools` · `systemPrompt` · `agents` ([`packages/memory/tool-memory/src/index.ts`](../packages/memory/tool-memory/src/index.ts))
