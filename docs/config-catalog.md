...
Source: [`packages/extensions/cordis-static-packages/src/index.ts:53`](../packages/extensions/cordis-static-packages/src/index.ts)
...
Source: [`packages/llm/llm-antigravity/src/index.ts:32`](../packages/llm/llm-antigravity/src/index.ts)
...
Source: [`packages/llm/llm-ollama/src/index.ts:57`](../packages/llm/llm-ollama/src/index.ts)
...
Source: [`packages/subagent/subagent-claude-code/src/index.ts:47`](../packages/subagent/subagent-claude-code/src/index.ts)
...
Requires: `tools` · `llm` · `fs` · `attachments`
...
Source: [`packages/llm/tool-classify-image/src/index.ts:60`](../packages/llm/tool-classify-image/src/index.ts)
...
Source: [`packages/memory/tool-memory/src/index.ts:24`](../packages/memory/tool-memory/src/index.ts)
...
- `@deepseek-ai/dsh-memory` — requires `storageDomain` ([`packages/memory/memory/src/index.ts`](../packages/memory/memory/src/index.ts))
